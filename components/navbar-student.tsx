...
export function NavigationStudent() {
  ...
  const navigationItems = [
    ...
    { url: "/student-extra-sessions", title: "Extra Sessions" },
    { url: "/student-session-progress", title: "Session Progress" },
  ];
      ...
      <div className="md:flex items-center justify-between w-full hidden z-50">
        ...
        <NavigationMenu className="-z-20">
          <NavigationMenuList>
            ...
            <NavigationMenuItem>
              <Link href="/student-extra-sessions" legacyBehavior passHref>
                <NavigationMenuLink className={navigationMenuTriggerStyle()}>
                  Extra Sessions
                </NavigationMenuLink>
              </Link>
            ...
            <NavigationMenuItem>
              <Link href="/student-session-progress" legacyBehavior passHref>
                <NavigationMenuLink className={navigationMenuTriggerStyle()}>
                  Session Progress
                </NavigationMenuLink>
              </Link>
